  ...
  return (
    <Layout>
      ...
      <Section
        ...
        alt
      >
          <p className="text-gray-700 mb-4 leading-relaxed">Our recommendations are based on dated, checkable sources: rental price checks from April 2026, parking rate verification with DOO Parking Servis Ulcinj from February 2024, and border-travel reports collected between 2024 and 2026.</p>
          <p className="text-gray-700 mb-4 leading-relaxed">Insurance conditions are compared against Montenegro’s <strong>Law on Compulsory Traffic Insurance (Official Gazette No 44/12)</strong> and standard rental contract terms including CDW, SCDW, FDW, excess/deductible, and Green Card coverage for cross-border trips.</p>
          <DataTable headers={["Check", "Source", "What We Verify"]} rows={[["Pricing", "Direct agency quotes", "Example daily rates, deposits, and seasonal changes"], ["Parking", "DOO Parking Servis Ulcinj", "Zone prices and enforcement timing"], ["Border rules", "2024-2026 traveler reports", "Opening hours, document checks, and wait times"], ["Insurance", "Official Gazette No 44/12", "Required liability cover and optional extras"], ["Roads", "Local driving tests", "Travel times on E-65, E-851, Sozina Tunnel, and Jadranska Magistrala"]]} />
