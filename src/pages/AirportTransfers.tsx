  ...
  return (
    <Layout>
      ...
      >
          ...
          <p className="text-gray-700 mb-4 leading-relaxed"><strong>Road note:</strong> the highway alignment between Podgorica and the coast is mainly associated with <strong>E-65</strong>, while southern links toward Ulcinj and the border region are commonly referenced as <strong>E-851</strong> and <strong>R-17</strong> on local route planners. In practice, signage can vary, so a GPS app with offline maps is helpful. See our <a href="/driving-parking-guide" className="text-primary hover:underline">driving and parking guide</a> for speed limits, paid parking zones, and enforcement details.</p>
