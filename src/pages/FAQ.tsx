...
// Single source for the page and its FAQPage schema. `question` must always hold
// a real question — a bare "FAQ" in that slot meant four answers had been glued
// into one accordion item (split back out 2026-07-27).
// scripts/prerender.routes.json mirrors these pairs for the static head.
const FAQ_ITEMS = [
  ...
  { question: "Do I Need a Deposit or a Credit Card Preauthorisation?", answer: "Yes, most Ulcinj rental companies require a deposit preauthorisation on a credit card for the security hold. The amount often depends on the car class and can be linked to the excess/deductible or franchise stated in the contract. Cash-only agencies exist, but they may still ask for ID, a signed contract, or a separate cash deposit. <strong>Caveat:</strong> A card preauthorisation can stay blocked for several days after return, depending on your bank and the rental company’s release procedure." },
