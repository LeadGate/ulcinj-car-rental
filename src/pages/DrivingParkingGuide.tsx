  ...
  return (
    <Layout>
      ...
      >
          ...
          <p className="text-gray-700 mb-4 leading-relaxed">A Green Card is often required or strongly recommended for cross-border rental driving, and many agencies ask for it before approving the route to Shkodër or the Sukobin/Muriqan border. The practical benefit is that it helps show third-party liability coverage outside Montenegro, and some border officials may ask for it together with the rental agreement. The exception is that some rental fleets exclude Albania entirely, so written permission matters as much as the insurance document. See our <a href="/cross-border-car-rental-montenegro/" className="text-primary underline hover:opacity-80">cross-border car rental guide</a> for the full country-by-country rules, the Sukobin crossing, the Kosovo payload trap and fees.</p>
